...
async function main() {
  await db.insert(products).values({
    ...
    specifications: [
      ...
      { label: 'Weight', value: '150g (bare) / 260g (with packaging)' },
      { label: 'Folded dimensions', value: '182 × 60 × 18mm' },
      { label: 'Base footprint (deployed)', value: '110 × 60mm' },
      { label: 'Support arm length', value: '~115mm' },
      { label: 'Maximum screen height lift', value: '180–200mm' },
      { label: 'Rotation', value: '360° (magnetic head) / 180° (base)' },
      { label: 'Compatible devices', value: 'Smartphones 4.7"+, tablets, laptops up to ~16"' },
      { label: 'MagSafe compatibility', value: 'Yes (ring magnet array; non-magnetic devices use included metal ring)' },
      { label: 'Surface finish', value: 'Sand-blasted + anodised' },
      { label: 'Colours', value: 'Gunmetal / Grey' },
    ],
    faqs: [
      {
