...
const newProducts = [
  ...
  {
    id: 'wp-207-precision-brass-place-card-holder',
    name: 'Precision Brass Place Card Holder',
    tagline: 'Solid brass | 20-100mm size range | 15 display formats',
    highlights: [
      'Solid brass construction for visible metal weight and stable desk placement.',
      'Multi-format series covering round, square, bar, cylindrical, and inclined shapes.',
      'Slot-top design for business cards, place cards, menu cards, and small desk signs.',
    ],
    description:
    ...
    heroImage: '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-cover.avif',
    images: [
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-cover.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-hover.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-1.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-2.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-3.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-4.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-5.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-6.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-detail-7.avif',
      '/products/WP-207-precision-brass-place-card-holder/precision-brass-place-card-holder-lifestyle.avif',
    ],
    moq: 100,
    customizationOptions: ['Logo Engraving', 'Size Adjustment', 'Surface Finish Options', 'Custom Packaging'],
    sortOrder: 50,
    active: true,
  },
  {
