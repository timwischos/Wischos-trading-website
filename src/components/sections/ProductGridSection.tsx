...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  'Writing Instruments': 'Corporate pens and writing tools built for daily use. Our selection covers precision ballpoints, rollerball pens, and mechanical pencils in solid brass, stainless steel, and aluminium — materials that communicate substance without saying a word. Unlike promotional giveaways, these are objects recipients keep on their desks and reach for by choice. Each piece supports laser engraving with a company name, logo, or recipient\'s initials, turning a functional tool into a personalised keepsake. Client briefs in this category typically cover new hire onboarding kits, milestone recognition, conference gifts, and long-service awards. Five brass pens, five roles — same material family, different mechanisms and weights to match the brief.',
  'Desk Accessories': 'Precision-made desk objects for corporate gifting. This category includes aluminium mouse pads, pen holders, desk organisers, spinning tops, custom bookmarks, and other functional pieces built for professional environments. The weight and finish quality are immediately apparent when handled — these are not catalogue fillers. All pieces support laser engraving or surface printing for corporate branding. Common client briefs: executive welcome kits, team recognition gifts, client appreciation sets, and event presentations.',
  'Drinkware': 'Premium metal drinkware for corporate gifting programs. Our range covers pure titanium bottles, vacuum-insulated stainless steel tumblers, and bamboo-groove mugs — functional gifts that accompany recipients through their workday and beyond. Titanium is a standout choice: lighter than steel, corrosion-resistant, and free of metallic taste. All pieces support laser engraving on the body or lid. Client briefs that fit this category: team recognition, client appreciation packages, wellness-focused onboarding kits, and executive welcome programs.',
  'EDC Accessories': 'Everyday carry accessories made for professionals who value functional precision. This category includes titanium multi-tools, stainless steel key organisers, EDC pry bars, letter openers, and pocket tools designed for daily use and long-term durability. Each piece is compact, purposeful, and built to a standard that holds up over years of use. All pieces support laser engraving for personalisation. Client briefs that fit this category: high-value client gifts, executive welcome programs, and recognition awards where lasting daily use is part of the brief.',
}
