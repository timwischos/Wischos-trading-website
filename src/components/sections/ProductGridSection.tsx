...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  'Writing Instruments': 'Corporate pens and writing tools built for daily use. Our selection covers precision ballpoints, rollerball pens, and mechanical pencils in solid brass, stainless steel, and aluminium — materials that communicate substance without saying a word. Unlike promotional giveaways, these are objects recipients keep on their desks and reach for by choice. Each piece supports laser engraving with a company name, logo, or recipient\'s initials, turning a functional tool into a personalised keepsake. Suitable for new client onboarding kits, employee milestones, conference gifts, and long-service awards. Five brass pens, five roles. Same material family, different mechanisms and weights — match the pen to how your recipient will actually use it.',
